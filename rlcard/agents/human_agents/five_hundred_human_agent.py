'''
    File name: five_hundred_human_agent.py
...
class HumanAgent(object):
    ''' A human agent for Five Hundred. It can be used to play alone to understand how the five hundred code runs
    '''
...
def _print_state(state, raw_legal_actions, action_record):
    ...
    # TODO: Implement equivalent state printout for Five Hundred. Below is the Blackjack equivalent
    # print('\n=============   Dealer Hand   ===============')
